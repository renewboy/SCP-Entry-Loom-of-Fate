export const en = {
  ...
  game: {
    ...
    npc_move: "{name} moved to {location}",
  },
  endings: {
    contained: {
  ...
  npc_panel: {
    ...
    empty: "No NPC data available",
    location_unknown: "Unknown location",
    last_action: "Recent Action",
    no_recent_action: "No recent action",
    masked: "████████",
    perspective: "Perspective",
    no_summary: "No perception summary",
    target_player: "Player",
    action_move: "Moves to {location}",
    action_talk: "Says to {target}: {content}",
    action_general: "{description}",
  },
  settlement: {
    current_turn: "Current Settlement",
    history: "Settlement History",
    map_changes: "Map Changes",
    map_change_empty: "No changes recorded",
    npc_results: "NPC Adjudication",
    npc_result_empty: "No NPC results",
    map_change_token_add: "Access granted: {token}",
    map_change_npc_move: "{name} → {location}",
    map_change_npc_dead: "{name} status: Deceased",
    map_change_objective_update: "Objective update: {title} → {status}",
    map_change_objective_add: "Objective added: {title}",
    map_change_objective_delete: "Objective removed: {title}",
