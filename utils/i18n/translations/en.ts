export const en = {
  ...
  editor: {
    ...
    msg_export: "Map Blueprint JSON (Copy this):",
    btn_close: "Close",
    btn_copy: "Copy",
    btn_import: "Import",
    btn_edit_blueprint: "EDIT BLUEPRINT",
    preview_hint: "Intelligence retrieved. Review the area layout before insertion. You may adjust the blueprint to correct intelligence errors.",
