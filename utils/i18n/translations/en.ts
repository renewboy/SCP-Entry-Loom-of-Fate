export const en = {
  ...
  report: {
    ...
    narrative_quality: "NARRATIVE CRAFT ASSESSMENT",
    nq_world_consistency: "World Consistency",
    nq_imagery: "Imagery & Language",
    nq_npc_depth: "NPC Depth",
    nq_pacing: "Pacing",
    nq_interactivity: "Interactivity",
    nq_equivalent_exchange: "Equivalent Exchange",
    nq_comment: "Narrative Assessment",
    nq_overall: "Overall",
  },
  ai: {
  ...
  settings: {
    ...
    ai_provider_custom: "OpenAI-Compatible",
    ai_api_key: "API Key",
    ...
    ai_section_connections: "Provider Connections",
    ai_section_usage_models: "Models by Use",
    ai_provider_connection_help: "Select a provider and fill in its connection details. Saving only validates providers currently used by the model choices.",
    ai_model_usage_help: "Choose models for different uses. Keep the defaults if you want the simple setup.",
    ai_route_provider: "Provider",
    ai_route_model: "Model",
    ai_route_analysis_label: "Opening & Setup Generation",
    ai_route_analysis_help: "Used to parse SCP entries, generate character profiles, and prepare maps and initial setup.",
    ai_route_assistant_label: "Story Editor AI",
    ai_route_assistant_help: "Used for the Story Editor assistant, tool calls, and assistant search.",
    ai_route_narration_label: "Main Story Text",
    ai_route_narration_help: "Used for opening narration, turn-by-turn story text, ending reports, and Q&A.",
    ai_route_image_label: "Image Generation",
    ai_route_image_help: "Used for background images, entity images, NPC portraits, and turn illustrations.",
    ai_route_embedding_label: "Memory Retrieval",
    ai_route_embedding_help: "Used to convert story memories into vectors for timeline recall and RAG.",
    ai_embedding_unavailable: "Only Gemini memory retrieval models are currently supported.",
