export const en = {
  ...
  editor: {
    ...
    btn_copy: "Copy",
    btn_import: "Import",
    btn_edit_blueprint: "EDIT MAP",
    preview_hint: "Intelligence retrieved. Review the area layout before insertion. You may adjust the map to correct intelligence errors.",
