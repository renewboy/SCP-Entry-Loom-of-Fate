export const zh = {
  ...
  npc_panel: {
    ...
    last_action: "最近行动",
    no_recent_action: "暂无行动",
    masked: "████████",
    perspective: "角色视角",
    no_summary: "暂无感知摘要",
    target_player: "玩家",
    action_move: "移动至 {location}",
    action_talk: "对 {target} 说：{content}",
  ...
  settlement: {
    ...
    history: "历史结算",
    map_changes: "地图变化",
    map_change_empty: "暂无变化",
    npc_results: "NPC 结算",
    npc_result_empty: "暂无结算信息",
    map_change_token_add: "获得权限：{token}",
    map_change_npc_move: "{name} → {location}",
    map_change_npc_dead: "{name} 状态：已阵亡",
    map_change_objective_update: "任务更新：{title} → {status}",
    map_change_objective_add: "新增任务：{title}",
    map_change_objective_delete: "移除任务：{title}",
    empty: "暂无结算记录",
  },
  legacy: {
    new_game_plus: "开启新周目",
