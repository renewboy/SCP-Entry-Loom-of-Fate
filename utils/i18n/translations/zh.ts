export const zh = {
  ...
  report: {
    ...
    narrative_quality: "叙事技法评估",
    nq_world_consistency: "世界观一致性",
    nq_imagery: "意象与文笔",
    nq_npc_depth: "NPC 塑造深度",
    nq_pacing: "节奏控制",
    nq_interactivity: "交互响应性",
    nq_equivalent_exchange: "等价交换",
    nq_comment: "叙事总评",
    nq_overall: "综合",
  },
  ai: {
  ...
  settings: {
    ...
    ai_provider_custom: "OpenAI 兼容",
    ai_api_key: "API Key",
    ai_api_key_note: "本游戏不会储存您的 API Key，仅保存在浏览器本地。",
    ai_base_url: "Base URL",
    ai_chat_model: "聊天模型",
    ai_image_model: "图像模型（可选）",
    ai_section_connections: "供应商连接",
    ai_section_usage_models: "按用途选择模型",
    ai_provider_connection_help: "选择供应商并填写对应连接信息。保存时只会校验当前用途实际使用到的供应商。",
    ai_model_usage_help: "为不同用途选择模型。想简单使用时，保持默认即可。",
    ai_route_provider: "供应商",
    ai_route_model: "模型",
    ai_route_analysis_label: "开局与设定生成",
    ai_route_analysis_help: "用于解析 SCP、生成角色档案、整理地图与初始设定。",
    ai_route_assistant_label: "故事编辑器 AI",
    ai_route_assistant_help: "用于故事编辑器助手、工具调用和助手内搜索。",
    ai_route_narration_label: "主线故事文本",
    ai_route_narration_help: "用于游戏开局叙事、每回合正文、结局报告与问答。",
    ai_route_image_label: "图片生成",
    ai_route_image_help: "用于背景图、实体图、NPC 图和回合插图。",
    ai_route_embedding_label: "记忆检索",
    ai_route_embedding_help: "用于把剧情记忆转成向量，支持时间线回忆与 RAG。",
    ai_embedding_unavailable: "当前仅支持 Gemini 记忆检索模型。",
    ai_save: "保存配置",
    ai_clear: "清空配置",
  ...
  entity_profile: {
    ...
    subject_name: "名称/代号",
    chronological_age: "存在时长/年龄",
    capabilities: "特殊能力",
    origin: "起源/背景",
    narrative_anchors: "叙事锚点/关键词",
    confirm_upload: "上传至数据库",
    reroll: "重新生成候选项",
    custom_edit: "手动添加",
    auto_decrypt: "自动解密",
    click_to_skip: "点击任意处跳过",
    enter_augmentation_checkbox: "进入档案补全程序",
    auto_proceed_msg: "自动生成序列已启动",
    initialize_generation: "初始化档案生成",
    profile_generation_standby: "等待手动初始化...",
    loading: "处理中...",
    section_status: "状态",
    section_actions: "操作",
    candidates_ready: "候选项已就绪",
    generation_error: "生成失败",
    generation_error_detail: "数据库错误。请手动添加。",
    status_hint: "等待授权人员指令。",
    transition_accessing: "正在访问数据库：{designation}...",
