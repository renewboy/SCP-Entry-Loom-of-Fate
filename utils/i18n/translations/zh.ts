export const zh = {
  ...
  tutorial: {
    ...
    settings_title: "设置菜单",
    settings_desc: "右上角设置菜单用于存档、读取进度及终止本次行动。建议在关键决策节点前执行存档。",
    next: "下一步",
    skip: "跳过教程",
    finish: "开始编织",
  },
  ...
  map_editor: {
    ...
    discoverables: "可发现物 (Discoverables)",
    interactables: "可互动物 (Interactables)",
    visual_hint: "视觉提示 (Visual Hint)",
    map_id: "地图 ID",
    map_title: "地图标题",
