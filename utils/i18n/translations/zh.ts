export const zh = {
  ...
  editor: {
    ...
    msg_export: "地图蓝图 JSON (请复制)：",
    btn_close: "关闭",
    btn_copy: "复制",
    btn_import: "导入",
    btn_start_weave: "开始编织",
    btn_edit_blueprint: "编辑蓝图",
    tactical_preview: "战术预演",
    preview_hint: "在进入该区域前，你通过基金会数据库获得了以下情报。你可以调整蓝图以修正情报误差。",
