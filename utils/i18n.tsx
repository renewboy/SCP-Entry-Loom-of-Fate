...
export const translations = {
  zh: {
    ...
    game: {
      ...
      resource_health: "生命状态",
      resource_cognition: "认知清晰度",
      resource_integrity: "收容完整度",
      resource_reputation: "声望/信任",
      resource_inventory: "装备清单",
      resource_inventory_empty: "无物品",
      archive_access: "档案访问",
      role: "角色",
      class: "项目等级",
      turn: "回合",
    ...
    report: {
      ...
      resource_trends: "多资源轨迹",
      phase_dist: "稳定性阶段分布",
      phase_stable: "稳定期",
      phase_fluct: "波动期",
      phase_critical: "临界期",
      delta_chart: "稳定性变化量（每回合）",
      resource_drop_reasons: "关键跌落原因",
      resource_drop_delta: "跌落幅度",
      resource_drop_trigger: "触发动作",
      largest_drop: "最大下跌",
      ...
      video_script_title: "广播剧本 (Audio Drama)",
      generating_script: "正在生成剧本...",
      copy_script: "复制剧本",
      script_copied: "已复制",
      play_drama: "播放广播剧",
      generating_visuals: "正在生成视觉影像...",
    },
    save_load: {
      save: "保存游戏",
      load: "读取游戏",
  ...
  en: {
    ...
    game: {
      ...
      resource_cognition: "Cognition",
      resource_integrity: "Containment Integrity",
      resource_reputation: "Reputation",
      resource_inventory: "Inventory",
      resource_inventory_empty: "None",
    ...
    report: {
      ...
      resource_trends: "Multi-Resource Trajectories",
      ...
      resource_drop_reasons: "Key Drop Reasons",
      resource_drop_delta: "Drop Delta",
      resource_drop_trigger: "Trigger Action",
