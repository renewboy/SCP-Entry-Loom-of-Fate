...
const GameLogo: React.FC<GameLogoProps> = ({ className = "", color = "currentColor" }) => {
  ...
  return (
    ...
    >
        {/* Inner Ring - Stroked */}
        <circle cx="67.7" cy="71.5" r="33" fill="none" stroke={color} strokeWidth="6" />
        
        {/* Outer Shield/Sawtooth - Stroked */}
        <path d={shieldPath} fill="none" stroke={color} strokeWidth="4" />
