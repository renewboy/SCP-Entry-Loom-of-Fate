...
const EntityProfileAugmentation: React.FC<EntityProfileAugmentationProps> = ({
    ...
    return (
        <div className="w-full h-full relative bg-[var(--scp-bg)] text-[var(--scp-text)] font-mono flex flex-col overflow-hidden scp-ui crt">
            ...
            {/* Header */}
            <div className="h-14 border-b border-[var(--scp-border)] flex items-center justify-between px-6 bg-[var(--scp-surface)] shrink-0 z-10">
                <div className="flex items-center gap-4">
                    <button onClick={onBack} className={toolbarButtonBase}>
                        <span>←</span> {t('common.back')}
                    </button>
                    <h1 className="text-lg font-bold tracking-widest text-scp-alert flex items-center gap-2">
                            ...
                            <div className="scp-card p-4 space-y-3">
                                ...
                                {candidates.length === 0 && loadingAction !== 'reroll' && (
                                    <button 
                                        ...
                                        className="w-full px-6 py-4 border border-scp-accent text-scp-accent hover:bg-scp-accent/10 transition-all uppercase tracking-widest font-bold text-sm shadow-[0_0_15px_rgba(255,0,0,0.3)] disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                ...
                                {candidates.length > 0 && (
                                    <button 
                                        ...
                                        disabled={loadingAction !== null}
                                        className="w-full py-3 border border-scp-gray/30 hover:bg-white/5 text-xs font-mono uppercase tracking-wider disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                ...
                <div className={`flex-1 ${panelContainerBase} border border-[var(--scp-border)] p-0 flex flex-col z-10 shadow-2xl crt ${!selectedProfile ? 'opacity-50 pointer-events-none grayscale' : ''}`}>
                    ...
                    <div className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar">
                        ...
                        <div className={inputGroup}>
                            ...
                            <textarea 
                                className={`${textareaBase} h-32 resize-none`}
                    ...
                    <div className="p-4 border-t border-[var(--scp-border)] bg-[var(--scp-surface-2)] flex justify-end">
                        <button 
                        ...
                        >
                            <div className="flex items-center gap-3 justify-center">
                                <span className="font-report font-bold text-xl tracking-[0.2em]">{t('entity_profile.confirm_upload')}</span>
